        ...
        <div className="flex flex-col w-full items-center">
            ...
            <div className="flex w-full h-96 justify-center mt-24">
                <section className="flex flex-col items-center justify-between w-3/12">
                    <div 
                    className="bg-orange-300 hover:bg-orange-600 w-4/12 text-2xl rounded-lg"
                ...
                <div className=" bg-orange-300 w-8/12"><Image src={contentsFile} alt=''/><div>기능 소개 영상 들어가야 함</div></div>
            </div>
        </div>
    );
}
