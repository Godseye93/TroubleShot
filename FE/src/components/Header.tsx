...
export default function Header() {
  return (
    <div className="bg-white rounded-lg flex text-xl justify-between fixed top-2 left-2 right-2 shadow-md">
      ...
      <div className="w-2/12 h-2/12 flex items-center justify-end">
        <button className="bg-yellow-400 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded h-5/6 fcc me-2">
          로그인
        </button>
      </div>
    </div>
