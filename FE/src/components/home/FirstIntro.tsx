...
export default function FirstIntro() {
  return (
    <div id="firstIntro" className="flex flex-col items-center mt-28">
      ...
      <Link href="#" className=" mt-10 mb-3 w-1/4 bg-gray-500 flex justify-center items-center text-2xl p-3 hvc">
        with VSC <Image src={vscode_logo} alt="vscode_logo" className=" w-10 ml-5" />
      </Link>
      <Link href="#" className=" mb-3 w-1/4 bg-gray-500 flex justify-center items-center text-2xl p-3 hvc">
