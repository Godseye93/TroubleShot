    ...
    <div className="bg-gradient-to-b from-black">
      ...
      <main className="flex flex-col items-center gap-4 text-white">
        ...
        <div className="flex flex-col items-center mb-10 w-10/12">
          ...
          <Link href="#" className=" mt-10 mb-3 w-1/4 bg-gray-500 flex justify-center items-center text-2xl p-3 hover:bg-yellow-400">with VSC <Image src={vscode_logo} alt="vscode_logo" className=" w-10 ml-5" /></Link>
          <Link href="#" className=" mb-3 w-1/4 bg-gray-500 flex justify-center items-center text-2xl p-3 hover:bg-yellow-400">with IntelliJ <Image src={intelliJ_logo} alt="intelliJ_logo" className=" w-10 ml-5" /></Link>
          <Link href="#" className=" mb-3 w-1/4 bg-gray-500 flex justify-center items-center text-2xl p-3 hover:bg-yellow-400">with Chrome <Image src={chrome_logo} alt="chrome_logo" className=" w-10 ml-5" /></Link>
        </div>
        <div className="flex flex-col w-full items-center">
          <h1 className=" mt-32 text-7xl">트러블 샷의 주요 기능</h1>
          <div className="flex w-full justify-center">
            <section className="flex flex-col w-3/12">
              <div className="bg-orange-300 hover:bg-orange-600 w-4/12 text-2xl"><button>기능 1</button></div>
              <div className="bg-orange-300 hover:bg-orange-600 w-4/12 text-2xl"><button>기능 2</button></div>
              <div className="bg-orange-300 hover:bg-orange-600 w-4/12 text-2xl"><button>기능 3</button></div>
            </section>
