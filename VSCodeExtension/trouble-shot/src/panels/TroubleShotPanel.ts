      ...
      async (message: any) => {
        ...
        switch (command) {
          ...
          case "solveTrouble":
            if (isOffLineTrouble(message.articleInfo.troubleId)) {
              ...
              const res = await fetch(
                `http://orientalsalad.kro.kr/api/troubleshooting/trouble-shootings/${message.articleInfo.troubleId}/answers`,
                {
                  method: "POST",
                  headers: {
            ...
            return;
          case "onLogin":
            fetch("http://orientalsalad.kro.kr/api/user/login/login", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
              },
          ...
          case "uploadTrouble":
            ...
            fetch("http://orientalsalad.kro.kr/api/troubleshooting/trouble-shootings", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
              },
          ...
          case "getSolution":
            if (isOffLineTrouble(message.troubleId)) {
              ...
              if (!context) return;
              const res = await fetch(
                "http://orientalsalad.kro.kr/api/troubleshooting/gpt/error-feedback",
                {
                  method: "POST",
                  headers: {
                    "Content-Type": "application/json",
